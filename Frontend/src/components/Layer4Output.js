...
export default function Layer4Output({ data }) {
  if (!data) {
    return (
      <div className="mt-6 p-8 bg-bg-section rounded-lg text-center">
        <p className="text-text-secondary">No Layer 4 QTO data available</p>
      </div>
    );
  }
  ...
  return (
    <div className="mt-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-xl font-bold text-brand-charcoal">Layer 4 — Quantity Takeoff (QTO)</h3>
